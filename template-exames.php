               ...
               <main id="main" class="site-main" role="main">
                    ...
                    <div class="lista">
                        <ul class="text-sm-center">                          
                            ...
                            <a href="<?php echo add_query_arg( array('var'=>'1') ) ?>"><li <?php if( $var == '1' ) echo 'class="select"'; ?>>1</li></a>
                            <a href="<?php echo add_query_arg( array('var'=>'2') ) ?>"><li <?php if( $var == '2' ) echo 'class="select"'; ?>>2</li></a>
                            <a href="<?php echo add_query_arg( array('var'=>'3') ) ?>"><li <?php if( $var == '3' ) echo 'class="select"'; ?>>3</li></a>
                            <a href="<?php echo add_query_arg( array('var'=>'5') ) ?>"><li <?php if( $var == '5' ) echo 'class="select"'; ?>>5</li></a>
                        </ul>
                    </div>
                        ...
                        <ul class="lista-exames">
                            <?php
                                ...
                                $query = "
                                        ...
                                        AND         $wpdb->posts.post_type = 'exame'
                            ...
                            <?php 
                                endforeach;
                                else echo '<p>Nenhum exame cadastrado começando por <i>"'. $letra .'"</i></p>';
